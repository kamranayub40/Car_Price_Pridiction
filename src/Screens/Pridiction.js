    ...
    return(
        ...
        <ScrollView behaviour = "height"
            ...
            {/* <View> */}
                ...
                <TouchableOpacity style={{borderRadius:28,marginBottom:10,marginLeft:20,backgroundColor:"rgba(0, 175, 156, 0.1);",width:"90%",height:"10%"}} onPress={()=>console.log("Clicked")}>
